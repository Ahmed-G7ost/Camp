      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <form onSubmit={submit} className="glass-card rounded-3xl p-8 space-y-5" data-testid="login-form">
          ...
          <button
            ...
            className="w-full font-tajawal font-bold rounded-xl px-4 py-3 flex items-center justify-center gap-2 transition-all duration-200 disabled:opacity-60 shadow-lg bg-gradient-to-l from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-blue-600/25"
          >
